bin/game: Line\ Obstacle.o Point\ Obstacle.o handle_next_event.o modules/x_utilities.o Polybolo.o Soldier.o Line\ Segment.o handle_collision.o Entity.o Trajectile.o\
	game.o
